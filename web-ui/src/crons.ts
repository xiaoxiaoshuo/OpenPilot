...
const CRON_TABS: Array<{ value: CronTab; label: string }> = [
  { value: "yours", label: t("crons.yours") },
  { value: "shared", label: t("crons.shared") },
  { value: "archived", label: t("crons.archived") },
];
...
function drawCronsPage(): void {
  ...
  render(
    listPageTpl({
      ...
      action: { label: t("crons.newCron"), onClick: showNewCron },
      search: {
        value: cronsSearch,
        placeholder: t("crons.search"),
        onInput: (value) => {
          cronsSearch = value;
          drawCronsPage();
        },
