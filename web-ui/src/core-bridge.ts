...
import { swallow } from "../../core/chassis/src/errors.ts";
...
export async function deleteSession(id: string): Promise<{ ok: true; id: string }> {
  return api<{ ok: true; id: string }>(`/api/sessions/${encodeURIComponent(id)}`, { method: "DELETE" });
}
