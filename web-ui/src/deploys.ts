...
const DEPLOY_TABS: Array<{ value: DeploymentTab; label: string }> = [
  { value: "yours", label: t("deploys.yours") },
  { value: "shared", label: t("deploys.shared") },
  { value: "archived", label: t("deploys.archived") },
];
  ...
  render(
    html`
      ${listPageTpl({
        ...
        action: { label: t("deploys.deployWithAgent"), onClick: deployWithAgent },
